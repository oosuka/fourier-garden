...
export const primeConstellationPattern: PrimeConstellationPatternDefinition = {
  ...
  education: {
    ...
    sonificationBody:
      "素数の昇順と隣接間隔Δⱼを保持し、発音時刻を(9.2/95)Δⱼ秒ずつ進めます。25素数を9.2秒へ比率保存で配置し、次の10秒句までの最大間隔を0.8秒に抑えます。素数値は立方根写像で440–920 Hzへ単調圧縮し、同じ絶対位相を連続定位にも使います。60秒を横断する強弱、尾長、wet輪郭、短い包絡、EQ、残響は聴取のための演出で、係数1/25は変えません。",
    poeticLayerBody:
