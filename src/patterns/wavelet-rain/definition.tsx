...
export const waveletRainPattern: WaveletRainPatternDefinition = {
  ...
  contrastProfile: {
    ...
    timbre: "dark-overlapping-wavelet-drop",
    rhythm: "dyadic-clustered-multiscale-bursts",
    time: "sixteen-second-support-scan",
    audio: {
      onsetPattern: "dyadic-support-clusters-with-sixty-four-second-weather",
      articulation: "overlapping-scale-dependent-drop",
      pitchMapping: "haar-scale-register",
      spatialGesture: "support-position-pan",
      wetCharacter: "dark-cool-rain-tail",
    },
  },
  dramaturgy: {
    cycleSeconds: 64,
