...
export const mobiusChoirPattern: MobiusChoirPatternDefinition = {
  ...
  education: {
    ...
    gentleBody:
      "帯の端をひねってつなぐと、声は継ぎ目を越えるたびに横向きを反転し、二周して元へ戻ります。56.470588秒・78イベントの五つの幕で密度と音域を変え、呼吸、応答、反転、重なり、収束を聴き分けます。",
    ...
    sonificationBody:
      "音声は波動場の無加工再生ではありません。√λの固有振動数比、bₘₙの基礎振幅比、許容条件、n>0の正弦・余弦対の位相関係を保持します。carrierを絶対transport時刻で連続評価し、モード変位と速度を振幅、部分音の明度、定位へ写します。78イベントには共通移調、母音フォルマント、二次mora、短い呼吸包絡、高域air tail、EQ、圧縮、残響、-1 dBFSリミッターを加え、前周期の余韻も絶対イベント時刻で評価します。",
    poeticLayerBody:
