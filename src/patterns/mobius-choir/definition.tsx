...
export const mobiusChoirPattern: MobiusChoirPatternDefinition = {
  ...
  education: {
    ...
    sonificationBody:
      "音声は波動場の無加工再生ではありません。√λの固有振動数比、bₘₙの基礎振幅比、許容条件、n>0の正弦・余弦対の位相関係を保持します。carrierを絶対transport時刻で連続評価し、モード変位と速度を振幅、部分音の明度、定位へ写します。78イベントには共通移調、母音フォルマント、短い呼吸包絡、EQ、圧縮、残響、-1 dBFSリミッターを加え、前周期の余韻も絶対イベント時刻で評価します。",
    poeticLayerBody:
