...
export const mobiusChoirPattern: MobiusChoirPatternDefinition = {
  ...
  education: {
    ...
    sonificationBody:
      "音声は波動場の無加工再生ではありません。√λを420-920 Hzの安全なpiko帯域へ圧縮し、bₘₙの基礎振幅比、許容条件、n>0の正弦・余弦対の位相関係を保持します。carrierを絶対transport時刻で連続評価し、モード変位と速度を振幅と定位へ写します。256イベントは単一partial、息成分なしの短い電子粒で、dry/wet両方の高域抑制EQ、圧縮、短い残響、-1 dBFSリミッターを加え、前周期の余韻も絶対イベント時刻で評価します。",
    poeticLayerBody:
