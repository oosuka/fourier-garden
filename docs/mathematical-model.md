...
この文書は2026年7月11日時点の正式版で通常公開済みのChapter 1
...
利用者による最終的な音色評価は2026年7月11日に完了し、正式版として承認済みである。
...
WebGPUとWebGL2は品質別のbloom profileを使い、highではstrength 1.18、
radius 0.36、threshold 0.82を基準にする。高いthresholdで深い黒を保持しながら、
柱芯、透明ハロー平面、局所フレア、
...
2026年7月11日の正式版QAでWebGPU／WebGL2の通常アプリと章別QA入口を確認し、
利用者による最終的な音色評価を経て通常公開している。
